...
export default function Navbar({ onLoginClick, isLoggedIn = false, onCartClick, username, onLogout }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            {/* Logic Đăng nhập / Đăng xuất Desktop */}
            {!isLoggedIn ? (
              <button 
              ...
              <div className="hidden sm:flex items-center gap-3">
                <div className="flex items-center gap-2 text-gray-700 font-medium bg-gray-100 px-3 py-2 rounded-lg">
                  <User size={18} />
                  <span className="hidden lg:inline">{username}</span>
                </div>
                <button 
                  onClick={onLogout}
                  className="flex items-center justify-center p-2 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-lg transition-all"
                  title="Đăng xuất"
                >
                  <LogOut size={20} />
                </button>
            ...
            <div className="px-4 mt-4 space-y-2">
              ...
              {!isLoggedIn ? (
                ...
                <div className="space-y-2">
                  <div className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-gray-100 rounded-lg text-gray-700 font-medium">
                    <User size={18} />
                  ...
                  <button 
                    ...
                    className="w-full flex items-center justify-center space-x-2 px-4 py-2 text-red-600 font-semibold border-2 border-red-600 rounded-lg hover:bg-red-50 transition-all duration-300 text-sm"
                  >
                    <LogOut size={18} />
                    <span>Đăng xuất</span>
                  </button>
